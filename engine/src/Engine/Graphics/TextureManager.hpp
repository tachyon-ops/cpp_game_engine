#ifndef ENGINE_GRAPHICS_TEXTUREMANAGER_H
#define ENGINE_GRAPHICS_TEXTUREMANAGER_H
...
public:
  ...
  void DrawWithRatio(std::string id, int x, int y, int width, int height,
                     double ratio = 1.0, SDL_RendererFlip flip = SDL_FLIP_NONE);
