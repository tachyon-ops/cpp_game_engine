...
CollisionHandler::CollisionHandler() { m_CollisionLayer = nullptr; }
...
bool CollisionHandler::MapCollision(SDL_Rect a, int tileSize, int RowCount,
                                    int ColCount) {
  if (m_CollisionLayer != nullptr) {
